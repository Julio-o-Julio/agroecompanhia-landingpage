...
export const MESSAGES = {
  ...
  caixa:
    "Olá! Quero um orçamento da Caixa Organizadora. Minha colheitadeira é: ",
...
export const STATS = [
  ...
  },
  {
    ...
    hint: "Projeto, corte e solda em casa",
  },
];
...
function photo(base: string, alt: string): ProductImage {
  const url = (suffix: string) =>
    asset(`/images/products/${base}-${suffix}.webp`);
  return {
    src: url("1152"),
...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    images: [
      ...
      photo(
        "foto-caixas",
        "Lote de caixas organizadoras no pátio da fábrica, prontas para carregar",
      ),
      photo(
        "foto-varias-caixas",
        "Caixas organizadoras alinhadas mostrando o acabamento da pintura",
      ),
    ],
...
export const COVERAGE = {
  ...
  regions: [
    {
      name: "Sul",
      detail: "Paraná, Santa Catarina e Rio Grande do Sul",
      contact: "sul",
    },
    {
      name: "Centro-Oeste",
